...
import Department from "./navigation-components/Department";
    ...
    function handleNavigationChange(ref){
        ...
        switch(ref.current.innerText){
            ...
            case 'Reports':
                ...
                break;
            case 'Department':
                setCurrentNavigation(<Department />)
                break;
            default:
                return;
        }
        ...
        <Container> 
            <Navigation>
                ...
                <Actions>
                    ...
                    <Action ref={departsRef} onClick={()=> handleNavigationChange(departsRef)}>Department</Action>
                </Actions>
            </Navigation>
